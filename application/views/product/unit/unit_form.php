        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Form <?= strtoupper($page) ?> Unit</h4>
                    <div class="card-header-action">
                        <a href="<?= site_url("unit"); ?>" class="btn btn-success"><i class='fa fa-arrow-left'></i> Back</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row justify-content-lg-center">
                        <div class="col-lg-4">
                            <form class="form" action="<?= site_url("unit/proces") ?>" method="POST">
