...
<head>
    ...
    <title><?= $this->fungsi->apps()->title_head ?></title>
        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block">Hi, <?= $this->fungsi->user_login()->name ?></div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?= site_url("auths/logout") ?>" class="dropdown-item has-icon text-danger">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"><?= $this->fungsi->apps()->title_apps ?></a>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    <?= $this->fungsi->apps()->copyright ?>
                </div>
                <div class="footer-right">
                    <?= $this->fungsi->apps()->version ?>
                </div>
            </footer>
        </div>
    </div>
